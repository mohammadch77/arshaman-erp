<div>
    ...
    <x-form wire:submit="save" class="gap-6 max-w-4xl">
        ...
        <x-card shadow title="صفحات سایت">
            <x-select
                label="صفحه اصلی"
                wire:model="homepage_page_id"
                :options="$this->publishedPages"
                option-value="id"
                option-label="title"
                placeholder="انتخاب نشده"
                placeholder-value=""
                hint="فقط صفحات منتشرشده قابل انتخاب‌اند"
                :icon="theme_icon('page')"
            />

            <x-select
                label="صفحه وبلاگ"
                wire:model="blog_page_id"
                :options="$this->publishedPages"
                option-value="id"
                option-label="title"
                placeholder="انتخاب نشده"
