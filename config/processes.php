...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | برچسب فارسی و راهنما برای فیلدهای شرط ماژول‌محور (بخش ۷ Session جاری)
    |--------------------------------------------------------------------------
    |
    | فقط برای condition_fields بالا (فرایند وصل‌به‌ماژول) — پنل طراحی
    | (ProcessDefinitionForm) این برچسب/راهنما را به‌جای نام انگلیسی خام ستون
    | نشان می‌دهد. فرایند آزاد نیازی به این نگاشت ندارد چون برچسب فیلد از
    | همان چیزی که خودِ ادمین در فرم درخواست تایپ کرده می‌آید.
    |
    */
    ...
    'condition_field_labels' => [
        Leave::class => [
            'days_count' => [
                ...
                'hint' => 'تعداد کل روزهای درخواست مرخصی (days_count روی رکورد مرخصی)',
            ],
            'leave_type' => [
                'label' => 'نوع مرخصی',
                'hint' => 'مقدار خام نوع مرخصی (annual/sick/unpaid/hourly) — مقایسه با متن انگلیسی، نه برچسب فارسی',
            ],
        ],
    ],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | آپلود فایل در فیلدهای نوع file (فرم درخواست/فرم اضافه‌ی مرحله)
    |--------------------------------------------------------------------------
    |
    | همان الگوی آپلود عکس ماژول SiteBuilder (Storage::put، مسیر root-relative
    | برای نمایش) — فقط اینجا نوع فایل هم PDF/تصویر مجاز است، نه فقط تصویر.
    | قابل‌تنظیم، نه هاردکد در کد.
    |
    */

    'file_upload' => [
        'disk' => 'public',
        'path' => 'processes/uploads',
